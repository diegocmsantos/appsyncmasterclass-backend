...
const a_user_calls_like = async (user, tweetId) => {
    ...
    console.log(`[${user.username}] - liked tweet with id [${tweetId}]`)
...
const a_user_calls_unlike = async (user, tweetId) => {
    ...
    console.log(`[${user.username}] - unliked tweet with id [${tweetId}]`)
...
const a_user_calls_retweet = async (user, tweetId) => {
    ...
    console.log(`[${user.username}] - retweet tweet [${tweetId}]`)
